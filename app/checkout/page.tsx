  ...
  if (!cart || cart.items.length === 0) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 sm:py-20 text-center space-y-4">
        ...
        <Link href="/products" className="inline-block px-5 py-2.5 bg-[#FF5E00] hover:bg-[#FF8C00] text-white rounded-xl text-xs font-semibold transition">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div
                ...
                className={`p-3.5 sm:p-4 rounded-2xl border-2 cursor-pointer transition flex flex-col justify-between min-h-[90px] ${
                  paymentMethod === "COD"
                    ? "border-[#FF5E00] bg-orange-50/50"
                    : "border-[#DDE2E6] hover:border-slate-300"
                }`}
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-[#1C2A39]">Cash on Delivery (COD)</span>
                  <input
                    type="radio"
