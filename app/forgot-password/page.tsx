      ...
      <div className="space-y-6">
        ...
        >
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-3.5 py-2.5 bg-slate-50 text-xs rounded-xl border border-slate-200 focus:outline-none focus:border-brand-500 transition"
              />
          ...
          <div className="text-center pt-2 text-xs text-slate-500">
            ...
            <Link href="/login" className="font-bold text-brand-600 hover:underline inline-flex items-center gap-1">
