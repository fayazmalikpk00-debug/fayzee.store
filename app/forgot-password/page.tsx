    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-[#0B0F14]">Forgot Password</h1>
        ...
        >
          ...
          <div className="text-center pt-2 text-xs text-[#8A8F98]">
            ...
            <Link href="/login" className="font-bold text-[#C8A96B] hover:text-[#D4B15A] hover:underline inline-flex items-center gap-1">
