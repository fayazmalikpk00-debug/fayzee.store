    ...
    return (
      <div className="max-w-xl mx-auto px-4 py-20 text-center space-y-4">
        ...
        <Link
          ...
          className="inline-block px-5 py-2.5 bg-brand-600 text-white text-xs font-bold rounded-xl shadow-md"
        >
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 space-y-8">
      <div className="text-center space-y-2">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-fayzee-coral to-amber-500 flex items-center justify-center text-white mx-auto shadow-md">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4 text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block font-bold text-slate-700 mb-1">Public Store Name</label>
            <input
              type="text"
              required
              value={storeName}
          ...
          <div>
            <label className="block font-bold text-slate-700 mb-1">Registered Business Entity</label>
            <input
              type="text"
              required
              value={businessName}
          ...
          <div>
            <label className="block font-bold text-slate-700 mb-1">Owner CNIC (Government ID)</label>
            <input
              type="text"
              required
              value={cnic}
          ...
          <div>
            <label className="block font-bold text-slate-700 mb-1">NTN / Tax Registration Number</label>
            <input
              type="text"
              value={taxNumber}
          ...
          <div>
            <label className="block font-bold text-slate-700 mb-1">Store Dispatch Address</label>
            <input
              type="text"
              required
          ...
          <div className="sm:col-span-2">
            <label className="block font-bold text-slate-700 mb-1">Store Description & Products</label>
            <textarea
              rows={3}
              required
              value={description}
        ...
        <button
          ...
          className="w-full py-3.5 bg-gradient-to-r from-fayzee-coral to-amber-600 hover:from-orange-600 hover:to-amber-600 disabled:opacity-50 text-white font-bold rounded-2xl shadow-md transition flex items-center justify-center gap-2"
        >
